...
const Login = () => {
  ...
  const titles = {
    login: { heading: "Welcome back", sub: "Sign in to manage your links" },
    signup: { heading: "Create your account", sub: "Start shortening links in seconds" },
      ...
      >
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center gap-2 mb-6">
            ...
            <span className="text-2xl font-bold font-heading">LinkForge</span>
          </Link>
